...
For a more practical demonstration, see `tree.py <https://github.com/willmcgugan/rich/blob/main/examples/tree.py>`_ which can generate a tree view of a directory in your hard drive.
