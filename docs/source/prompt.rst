...
The Prompt class was designed to be customizable via inheritance. See `prompt.py <https://github.com/Textualize/rich/blob/main/rich/prompt.py>`_ for examples.
